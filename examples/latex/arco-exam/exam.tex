...
\arcoFaculty{Escuela Superior de super Informática}
...
\begin{simpleQuestion}[1]
  ...
  \choice{Es el proceso de encapsulación que se realiza en la capa de
    enlace. Es el proceso de encapsulación que se realiza en la capa de enlace.}
